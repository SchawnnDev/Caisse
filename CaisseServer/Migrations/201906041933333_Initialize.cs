                ...
                c => new
                    {
                        ...
                        NeedsCup = c.Boolean(nullable: false),
                        Active = c.Boolean(nullable: false),
                        NumberingTracking = c.Boolean(nullable: false),
                        MaxSellNumberPerDay = c.Int(nullable: false),
                        Type_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        FirstName = c.String(),
                        Name = c.String(),
                        WasHere = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        GivenMoney = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Cashier_Id = c.Int(),
                ...
                c => new
                    {
                        ...
                        Name = c.String(),
                        Type = c.String(),
                        MinFee = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Event_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("public.events", t => t.Event_Id)
                ...
                c => new
                    {
                        ...
                        Start = c.DateTime(nullable: false),
                        End = c.DateTime(nullable: false),
                        SubstituteActive = c.Boolean(nullable: false),
                        Pause = c.Boolean(nullable: false),
                        Cashier_Id = c.Int(),
                        Checkout_Id = c.Int(),
                        Day_Id = c.Int(),
                        Substitute_Id = c.Int(),
